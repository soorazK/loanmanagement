...
from .views import (
    ...
    LoantypelistAPIView, LoantypeDetailAPIView, LoantypeUpdateAPIView, LoantypeDeleteAPIView,
    LoantypeCreateAPIView, PaymentlistAPIView, PaymentDetailAPIView, PaymentUpdateAPIView,
    PaymentDeleteAPIView, PaymentCreateAPIView, LoginView, LogoutView, UserUpdateAPIView,
    SendPasswordReset, ResetPassword, UserAddAPIView, CheckToken, GetLoanDetail, GetAnalytics,
    CheckPassword, TestView, LoanCalculatorView,  # , UserList, LoanView
)
