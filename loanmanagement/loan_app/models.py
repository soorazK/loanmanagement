...
class Loan(models.Model):
    ...
    recruit_position = models.CharField(max_length=50, null=True)
    recruit_level = models.CharField(max_length=50, null=True)
    recruit_office = models.CharField(max_field=50, null=True)
    current_position = models.CharField(max_length=50, null=True)
    current_level = models.CharField(max_length=50, null=True)
    current_office = models.CharField(max_length=50, null=True)
    citizenship_number = models.CharField(max_length=30, null=True)
    citizenship_issued_place = models.CharField(max_length=30, null=True)
    citizenship_issued_date = models.CharField(max_length=30, null=True)
    loan_for = models.CharField(max_length=50, null=True)
    loan_utilization_plae = models.CharField(max_length=50)
    service_break = models.CharField(max_length=100, null=True)
    vacations = models.CharField(max_length=100, null=True)
